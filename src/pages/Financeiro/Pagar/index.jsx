...
export default function FinanceiroPagar({ reg = null, tela }) {
    ...
    return (
        <Content>
            ...
            />
            <PagarTable data={services} handleEdit={handleEdit} refresh={fetchServices} tela={tela}/>
            {modalIsOpen && <PagarForm service={serviceEdited} onClose={() => { setModalIsOpen(false); setShouldReload(true); }} visible={modalIsOpen} />}
        </Content>
    )
}